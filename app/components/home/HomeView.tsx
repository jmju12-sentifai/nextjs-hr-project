...
import FunctionFinder from "./FunctionFinder";
 ...
 *
 * 운영 홈(/)과 시안 미리보기(/preview)가 같은 화면을 쓰도록 컴포넌트로 뺐다.
 * 시안에서 추가할 섹션은 extraSections 로 받아 인사기능별 목록과 로드맵 사이에 넣는다.
 */
...
export default async function HomeView({ extraSections }: { extraSections?: ReactNode }) {
