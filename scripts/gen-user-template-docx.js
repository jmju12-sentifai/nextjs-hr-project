...
[
  ...
  "선택형 항목(…유형·…방식·분기축 등)은 타입 칸에 「선택형」 이라고 쓰고, 설명 칸에 「값: 후보1/후보2/…」 로 허용값을 전부 나열하세요 — 앱에서 콤보박스가 되고, 문서 파싱도 그 값 중에서만 고릅니다.",
...
c.push(tbl([
  ...
  ["지급방식", "운영기준", "선택형", "필수", "지원금 지급 방식. 값: 일시금/분할", "일시금"],
...
c.push(tbl([
  ...
  ["경조분류", "—", "선택형", "필수", "어떤 경조사인지 — 계산이 갈리는 기준 (분기축). 값: 결혼/사망/출산", "결혼"],
  ["대상자관계", "—", "선택형", "선택", "대상자와의 관계. 값: 본인/배우자/자녀", "본인"],
